...
### Homebrew
`be-my-eyes.rb.template` is a formula template. Replace `{{VERSION}}` and SHA256 sums with release asset checksums, then commit into a tap repository (`fboucher/homebrew-tap`). Users install via:
```bash
